  ...
  async function getQuestion() {
    ...
    app.innerHTML = `
      <div id="question1M">
        ...
        <h1>Challenge 1</h1>
        <p><strong>Your time for this <span id="timer">${timeLeft}</span> seconds to respond if you do not respond in the given time you will lose</strong></p>
        <div id="question">
...
socket.on("notify-answer", (data) => {
  ...
  if (isCorrect) {
    navigateToMupi("/screenQuestion1LevelsM");
  } else {
    navigateToMupi("/noSelectedArtist");
  }
});
