    ...
    try {
      ...
      app.innerHTML = `
        ...
        <img src="https://ucqpslvexhojybodctlw.supabase.co/storage/v1/object/sign/resources/gusano%20rgeis.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV80NmU3Y2Y1MS05MjQwLTQ2NjktOWRmMS1mZDFkMjg2MzU4YTgiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJyZXNvdXJjZXMvZ3VzYW5vIHJnZWlzLnBuZyIsImlhdCI6MTc0OTQ5MTQ3MywiZXhwIjoxNzgxMDI3NDczfQ.5PKq4FBK4oPVbdnRjVh90kDuby88xZq8INaJFw7y6gg" alt="">
          ...
          <img id="fnd-q2" src="https://firebasestorage.googleapis.com/v0/b/algoritmosdatos2024-02.appspot.com/o/imagesPosts%2FGroup%20241.png?alt=media&token=b082988a-b0d1-4d9e-b5d9-9cbb658eb448" alt="">
        </div>
        `;
      timeout = setTimeout(() => {
        if (!hasAnswered) {
